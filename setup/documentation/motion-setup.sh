...
sudo chmod -R 777 /usr/local/squirrel-ai-mini/
...
root  ALL=(ALL:ALL) NOPASSWD: /usr/local/squirrel-ai-mini/motion-restart.sh
pi  ALL=(ALL:ALL) NOPASSWD: /usr/sbin/service  motion stop
pi  ALL=(ALL:ALL) NOPASSWD: /usr/sbin/service  motion start

crontab -e
@reboot sh /usr/local/squirrel-ai-mini/motion-restart.sh
